...
MODIFY_MAILMAN_DB = True  # not DEBUG
...
SECRET_KEY = 'npe&amp;y9^@b75nugzj#8_zagi_=xx+o2^o@=hs5selj%u(wddy^g'
...
ROOT_URLCONF = 'group_mail.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'group_mail.wsgi.application'
